...
pub struct RustRaftFaultScenarioRequirement {
    ...
    pub reference_raft_reference: String,
...
pub fn rustraft_reference_raft_fault_scenarios() -> Vec<RustRaftFaultScenarioRequirement> {
    vec![
        RustRaftFaultScenarioRequirement {
            scenario: RustRaftFaultScenario::PacketLossMajority,
            required_for_production: true,
            reference_raft_reference: "majority continues while the minority rejects stale reads/writes".to_string(),
            acceptance: vec![
        ...
        RustRaftFaultScenarioRequirement {
            ...
            required_for_production: true,
            reference_raft_reference: "partitioned peer heals, reconciles divergent tail, catches up, and only then becomes read eligible".to_string(),
            acceptance: vec![
        ...
        RustRaftFaultScenarioRequirement {
            ...
            required_for_production: true,
            reference_raft_reference: "slow WAL fsync activates backpressure without losing committed writes".to_string(),
            acceptance: vec![
        ...
        RustRaftFaultScenarioRequirement {
            ...
            required_for_production: true,
            reference_raft_reference: "snapshot floor and membership generation remain consistent across restart".to_string(),
            acceptance: vec![
        ...
        RustRaftFaultScenarioRequirement {
            ...
            required_for_production: true,
            reference_raft_reference: "leader transfer under active writes commits each accepted write exactly once".to_string(),
            acceptance: vec![
        ...
        RustRaftFaultScenarioRequirement {
            ...
            required_for_production: true,
            reference_raft_reference: "rejoining follower installs snapshot, replays retained tail, and becomes read-eligible only after catch-up".to_string(),
            acceptance: vec![
        ...
        RustRaftFaultScenarioRequirement {
            ...
            required_for_production: true,
            reference_raft_reference: "pending joint consensus survives rolling restarts and completes or rolls back safely".to_string(),
            acceptance: vec![
...
pub fn rustraft_fault_harness_readiness_report(
    ...
    let required_scenarios = rustraft_reference_raft_fault_scenarios();
