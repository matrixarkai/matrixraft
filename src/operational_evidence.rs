...
pub struct BaselineRaftOperationalEvidenceBundleValidationReport {
    ...
    #[serde(default)]
    pub read_safety_canonical_scenarios_match: bool,
    pub membership_valid: bool,
    #[serde(default)]
    pub membership_canonical_scenarios_match: bool,
...
pub fn matrixraft_validate_baseline_raft_operational_evidence_bundle(
    ...
    BaselineRaftOperationalEvidenceBundleValidationReport {
        ...
        read_safety_canonical_scenarios_match: read_safety.canonical_scenarios_match,
        membership_valid: membership.valid,
        membership_canonical_scenarios_match: membership.canonical_scenarios_match,
