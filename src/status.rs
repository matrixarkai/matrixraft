...
pub use crate::{
    ...
    rustraft_process_readiness_field_detail, rustraft_reference_raft_operational_evidence_bundle,
    rustraft_reference_raft_runtime_capability_report, rustraft_require_production_ready,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct RustRaftReferenceRaftRuntimeCapabilityReport {
    pub ready: bool,
    pub capability_evidence: Vec<RaftCapabilityEvidence>,
