...
#[test]
fn timeout_now_campaigns_only_followers_like_reference_raft() {
    let mut cluster = three_node_cluster();
    cluster.start().expect("cluster starts");
    cluster.set_prohibits_election(true);
...
#[test]
fn append_entries_preserves_matching_suffix_like_reference_raft() {
    let mut cluster = three_node_cluster();
    cluster.start().expect("cluster starts");
...
#[test]
fn append_entries_conflict_hint_skips_local_term_run_like_reference_raft() {
    let mut cluster = three_node_cluster();
    cluster.start().expect("cluster starts");
...
#[test]
fn append_entries_conflict_truncation_resets_pending_membership_change_like_reference_raft() {
    let mut cluster = three_node_cluster();
    cluster.start().expect("cluster starts");
...
#[test]
fn read_index_rejects_follower_requester_like_reference_raft() {
    let mut cluster = three_node_cluster();
    cluster.start().expect("cluster starts");
    cluster
