...
usage() {
  cat <<'USAGE'
Usage: verify_baseline_raft_benchmark_artifacts.sh [--rustraft-root PATH] --report PATH --summary PATH [--max-age-seconds N] [--release|--debug]

Verifies that a saved BaselineRaft-vs-RustRaft benchmark report and compact summary
